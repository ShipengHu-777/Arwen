...
class HomoDecisionTreeClient(DecisionTree):
    ...
    def fit(self):
        ...
        for dep in range(tree_height):
            ...
            a=pickle.dumps(split_info)
            with open("/data/projects/solo_train_split_result/" + consts.DatasetName + "/split_info_dep"+str(dep)+".pkl","wb") as f2:
                f2.write(a)
            '''

            # '''
            with open("/data/projects/solo_train_split_result/" + consts.DatasetName + "/split_info_dep"+str(dep)+".pkl","rb") as f2:
                b=f2.read()
            split_info=pickle.loads(b)
            # '''
